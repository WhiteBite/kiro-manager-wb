...
export const de: Translations = {
  ...
  patchStatusOutdated: 'Veraltet',
  patchVersion: 'Patch',
  patchVersionInstalled: 'installiert',
  patchVersionLatest: 'neueste',
  patchUpdateAvailable: 'Update verfügbar',
  kiroVersion: 'Kiro',
  patch: 'Patch',
  removePatch: 'Entfernen',
  updatePatch: 'Aktualisieren',
  ...
  strategyWebViewFeature1: 'Echter Browser-Fingerabdruck',
  strategyWebViewFeature2: 'Menschliches Verhalten',
  ...
  strategyAutomatedFeature1: 'Vollautomatisch',
  strategyAutomatedFeature2: 'Hohes Erkennungsrisiko',
  ...
  lowBanRisk: 'Niedriges Risiko',
  mediumBanRisk: 'Mittleres Risiko',

...
export const ja: Translations = {
  ...
  patchStatusOutdated: '古いバージョン',
  patchVersion: 'パッチ',
  patchVersionInstalled: 'インストール済み',
  patchVersionLatest: '最新',
  patchUpdateAvailable: 'アップデート可能',
  kiroVersion: 'Kiro',
  patch: 'パッチ',
  removePatch: '削除',
  updatePatch: '更新',
  ...
  strategyWebViewFeature1: '実際のブラウザフィンガープリント',
  strategyWebViewFeature2: '人間らしい動作',
  ...
  strategyAutomatedFeature1: '完全自動',
  strategyAutomatedFeature2: '高い検出リスク',

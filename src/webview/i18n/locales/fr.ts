...
export const fr: Translations = {
  ...
  newMessagesBelow: 'Nouveaux messages ci-dessous',
  ...
  patchStatusOutdated: 'Obsolète',
  patchVersion: 'Patch',
  patchVersionInstalled: 'installé',
  patchVersionLatest: 'dernier',
  patchUpdateAvailable: 'Mise à jour disponible',
  kiroVersion: 'Kiro',
  patch: 'Patch',
  removePatch: 'Retirer',
  ...
  patchKiroConfirm: "Ceci patchera Kiro pour utiliser un Machine ID personnalisé. Redémarrez Kiro après le patch. Continuer ?",
  ...
  // Empty States
  emptyAccountsTitle: 'Pas encore de comptes',
  emptyAccountsDesc: 'Créez votre premier compte pour commencer avec Kiro',
  emptySearchTitle: 'Aucun résultat',
  emptySearchDesc: 'Essayez un autre terme de recherche',
  emptyBannedTitle: 'Aucun compte banni',
  emptyBannedDesc: 'Tous vos comptes sont en bon état',
  ...
  strategyWebViewFeature1: 'Empreinte de navigateur réelle',
  strategyWebViewFeature2: 'Comportement humain',
  ...
  strategyAutomatedFeature1: 'Entièrement automatique',
  strategyAutomatedFeature2: 'Risque de détection élevé',
  ...
  lowBanRisk: 'Risque faible',
  mediumBanRisk: 'Risque moyen',
  ...
  oauthProviderDesc: 'Choisissez le fournisseur pour l\'inscription WebView',

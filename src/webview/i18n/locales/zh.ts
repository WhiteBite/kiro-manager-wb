...
export const zh: Translations = {
  ...
  patchStatusOutdated: '已过时',
  patchVersion: '补丁',
  patchVersionInstalled: '已安装',
  patchVersionLatest: '最新',
  patchUpdateAvailable: '有可用更新',
  kiroVersion: 'Kiro',
  patch: '打补丁',
  removePatch: '移除',
  updatePatch: '更新',
  ...
  strategyWebViewFeature1: '真实浏览器指纹',
  strategyWebViewFeature2: '人类行为模式',
  strategyAutomated: '自动化（旧版）',
  strategyAutomatedDesc: '使用DrissionPage自动化浏览器。对部分用户有效。',
  strategyAutomatedBanRisk: '中高封禁风险（40-90%）',
  strategyAutomatedFeature1: '完全自动',
  strategyAutomatedFeature2: '高检测风险',

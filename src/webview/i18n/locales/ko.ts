...
export const ko: Translations = {
  ...
  patchStatusOutdated: '구버전',
  patchVersion: '패치',
  patchVersionInstalled: '설치됨',
  patchVersionLatest: '최신',
  patchUpdateAvailable: '업데이트 가능',
  kiroVersion: 'Kiro',
  patch: '패치',
  removePatch: '제거',
  updatePatch: '업데이트',
  ...
  strategyWebViewFeature1: '실제 브라우저 지문',
  strategyWebViewFeature2: '인간적인 행동',
  ...
  strategyAutomatedFeature1: '완전 자동',
  strategyAutomatedFeature2: '높은 탐지 위험',

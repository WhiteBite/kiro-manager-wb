...
export const ru: Translations = {
  ...
  patchStatusOutdated: 'Устарел',
  patchVersion: 'Патч',
  patchVersionInstalled: 'установлен',
  patchVersionLatest: 'последний',
  patchUpdateAvailable: 'Доступно обновление',
  kiroVersion: 'Kiro',
  patch: 'Патч',
  removePatch: 'Убрать',
  updatePatch: 'Обновить',
  ...
  strategyWebViewFeature1: 'Реальный отпечаток браузера',
  strategyWebViewFeature2: 'Человеческое поведение',
  ...
  strategyAutomatedFeature1: 'Полностью автоматически',
  strategyAutomatedFeature2: 'Высокий риск обнаружения',
  ...
  lowBanRisk: 'Низкий риск',
  mediumBanRisk: 'Средний риск',
  highBanRisk: 'Высокий риск',
  banRiskLabel: 'Риск бана',
  auto: 'Авто',
  manual: 'Ручной',

  // OAuth Provider Selection
  oauthProvider: 'OAuth провайдер',
  oauthProviderDesc: 'Выберите провайдер для WebView регистрации',

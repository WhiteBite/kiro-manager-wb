...
export const en: Translations = {
  ...
  patchStatusOutdated: 'Outdated',
  patchVersion: 'Patch',
  patchVersionInstalled: 'installed',
  patchVersionLatest: 'latest',
  patchUpdateAvailable: 'Update available',
  kiroVersion: 'Kiro',
  patch: 'Patch',
  removePatch: 'Remove',
  updatePatch: 'Update',
  ...
  patchKiroConfirm: 'This will patch Kiro to use custom Machine ID. Restart Kiro after patching. Continue?',
  ...
  strategyWebViewFeature1: 'Real browser fingerprint',
  strategyWebViewFeature2: 'Human-like behavior',
  ...
  strategyAutomatedFeature1: 'Fully automatic',
  strategyAutomatedFeature2: 'High detection risk',
  ...
  lowBanRisk: 'Low risk',
  mediumBanRisk: 'Medium risk',
  highBanRisk: 'High risk',
  banRiskLabel: 'Ban risk',
  auto: 'Auto',
  manual: 'Manual',

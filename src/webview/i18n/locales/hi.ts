...
export const hi: Translations = {
  ...
  patchStatusOutdated: 'पुराना',
  patchVersion: 'पैच',
  patchVersionInstalled: 'स्थापित',
  patchVersionLatest: 'नवीनतम',
  patchUpdateAvailable: 'अपडेट उपलब्ध',
  kiroVersion: 'Kiro',
  patch: 'पैच',
  removePatch: 'हटाएं',
  updatePatch: 'अपडेट',
  ...
  strategyWebViewFeature1: 'वास्तविक ब्राउज़र फिंगरप्रिंट',
  strategyWebViewFeature2: 'मानव जैसा व्यवहार',
  ...
  strategyAutomatedFeature1: 'पूर्णतः स्वचालित',
  strategyAutomatedFeature2: 'उच्च पहचान जोखिम',
